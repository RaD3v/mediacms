!function () {
    ...
    t = {
        3170: function (e, t, n) {
            ...
            r = "page-embed",
            i = n(645).EmbedPage,
            (a = document.getElementById(r)) && i && l.render(o.createElement(i, null), a)
        },
        7714: function (e, t, n) {
            n.d(t, {
                M: function () {
            ...
            function l(e) {
                ...
                "link" === e.type ? r.createElement("a", o({}, n, {
                        href: e.href || null,
                        rel: e.rel || null
                    }), t) : "span" === e.type ? r.createElement("span", o({}, n, {
                        onClick: e.onClick || null
                    }), t) : r.createElement("button", o({}, n, {
                        onClick: e.onClick || null
                    }), t)
            }
            l.propTypes = {
        ...
        2917: function (e, t, n) {
            ...
            function s(e) {
                ...
                n,
                a = (0, r.useRef)(null),
                o = (t = (0, r.useState)(null), n = 2, function (e) {
                    if (Array.isArray(e))
                        return e
                }
                    (t) || function (e, t) {
                ...
                (0, r.useEffect)((function () {
                        !function () {
                            for (var e = 0; e < d.length; )
                                d[e].elem.removeEventListener("click", d[e].listener), e += 1;
                            d = []
                        }
                        (),
                        s && (function () {
                            ...
                            if (o.length)
                                for (t = 0; t < o.length; )
                                    (n = (n = o[t].getAttribute(e.pageIdSelectorAttr)) ? n.trim() : n) && (d[t] = {
                                            id: n,
                                            elem: o[t]
                                        ...
                                        (t), d[t].elem.addEventListener("click", d[t].listener)), t += 1;
            ...
            s.propTypes = {
                initPage: o().string,
                pages: o().object.isRequired,
                pageChangeSelector: o().string.isRequired,
                pageIdSelectorAttr: o().string.isRequired,
                focusFirstItemOnPageChange: o().bool,
                pageChangeCallback: o().func
            },
            s.defaultProps = {
        ...
        5671: function (e, t, n) {
            ...
            function s(e) {
                ...
                case "link":
                    t = r.createElement("a", l({}, e.linkAttr || {}, {
                                href: e.link,
                                title: e.text || null
                            }), t),
                ...
                case "button":
                case "open-subpage":
                    t = r.createElement("button", l({}, e.buttonAttr || {}, {
                                key: "button"
                            }), t);
                    break;
                case "label":
                    ...
                    break;
                case "div":
                    t = r.createElement("div", l({}, e.divAttr || {}, {
                                key: "div"
                            }), e.text || null)
                }
        ...
        1505: function (e, t, n) {
            ...
            var w = function (e) {
                ...
                function w(e) {
                    ...
                    if (function (e, t) {
                        if (!(e instanceof t))
                            ...
                            (this, w), (t = f.call(this, e)).state = {
                                displayPlayer: !1
                            }, t.videoSources = [], function (e) {
                            switch (e) {
                            case "running":
                                s.MediaPageStore.set("media-load-error-type", "encodingRunning"),
                                s.MediaPageStore.set("media-load-error-message", "Media encoding is currently running. Try again in few minutes.");
                                break;
                            case "pending":
                                s.MediaPageStore.set("media-load-error-type", "encodingPending"),
                                s.MediaPageStore.set("media-load-error-message", "Media encoding is pending");
                                break;
                            case "fail":
                                s.MediaPageStore.set("media-load-error-type", "encodingFailed"),
                                s.MediaPageStore.set("media-load-error-message", "Media encoding failed")
                            }
                        }
                            (t.props.data.encoding_status), null !== s.MediaPageStore.get("media-load-error-type"))return t.state.displayPlayer = !0, y(t);
                    if ("string" == typeof t.props.data.poster_url ? t.videoPoster = (0, u.formatInnerLink)(t.props.data.poster_url, t.props.siteUrl) : "string" == typeof t.props.data.thumbnail_url && (t.videoPoster = (0, u.formatInnerLink)(t.props.data.thumbnail_url, t.props.siteUrl)), t.videoInfo = (0, c.RA)(t.props.data.encodings_info, t.props.data.hls_info), Object.keys(t.videoInfo).length) {
                        ...
                        for (a in t.props.data.encodings_info[r])
                            t.props.data.encodings_info[r].hasOwnProperty(a) && o.support[a] && (i = t.props.data.encodings_info[r][a].url) && (i = (0, u.formatInnerLink)(i, t.props.siteUrl), t.videoSources.push({
                                    src: i,
                                    encodings_status: t.props.data.encodings_info[r][a].status
                                }))
                    } else
                        t.videoInfo = null;
                    ...
                    s.PageStore.on("switched_media_auto_play", t.onUpdateMediaAutoPlay.bind(g(t))),
                    t.browserCache = new d.BrowserCache(l.SiteContext._currentValue.id, 86400);
                    var p = new d.MediaDurationInfo;
                    return p.update(t.props.data.duration),
                ...
                (n = [{
                            ...
                            value: function () {
                                null !== this.recommendedMedia && (this.props.inEmbed || this.recommendedMedia.init(), this.playerInstance.player.on("fullscreenchange", this.recommendedMedia.onResize), s.PageStore.on("window_resize", this.recommendedMedia.onResize), s.VideoViewerStore.on("changed_viewer_mode", this.recommendedMedia.onResize))
                            }
                        }, {
                            key: "unsetRecommendedMedia",
                            value: function () {
                                null !== this.recommendedMedia && (this.playerInstance.player.off("fullscreenchange", this.recommendedMedia.onResize), s.PageStore.removeListener("window_resize", this.recommendedMedia.onResize), s.VideoViewerStore.removeListener("changed_viewer_mode", this.recommendedMedia.onResize), this.recommendedMedia.destroy())
                            }
                        }, {
                            key: "onClickNext",
                            value: function () {
                            ...
                            value: function (e, t) {
                                ...
                                null !== this.recommendedMedia && (this.recommendedMedia.initWrappers(this.playerElem.parentNode), this.props.inEmbed && (this.playerInstance.player.one("pause", this.recommendedMedia.init), this.initRecommendedMedia())),
                            ...
                            key: "onVideoEnd",
                            value: function () {
                                if (null !== this.recommendedMedia && (this.props.inEmbed || this.initRecommendedMedia(), this.recommendedMedia.updateDisplayType("full"), this.playerInstance.player.one("playing", this.onVideoRestart)), !this.props.inEmbed && s.MediaPageStore.get("playlist-id")) {
                                    ...
                                    return n && (e && (e.style.display = "none"), t && (t.style.display = "none"), window.location.href = n),
                                    void this.upNextLoaderView.hideTimerView()
                                }
                                this.upNextLoaderView && (s.PageStore.get("media-auto-play") ? (this.upNextLoaderView.startTimer(), this.playerInstance.player.one("play", function () {
                                            this.upNextLoaderView.cancelTimer()
                                        }
                            ...
                            value: function () {
                                ...
                                t = null,
                                n = null;
                                !this.props.inEmbed && s.MediaPageStore.get("playlist-id") ? (t = s.MediaPageStore.get("playlist-next-media-url"), n = s.MediaPageStore.get("playlist-previous-media-url")) : t = this.props.data.related_media.length && !this.props.inEmbed ? this.props.data.related_media[0].url : null;
                                var i = this.props.data.sprites_url ? {
                                ...
                                return r.createElement("div", {
                                    ...
                                    ref: "playerContainer"
                                        ...
                                        style: this.props.containerStyles
                                    }, this.state.displayPlayer && null !== s.MediaPageStore.get("media-load-error-type") ? r.createElement(p.hJ, {
                                            errorMessage: s.MediaPageStore.get("media-load-error-message")
                                        }) : null, this.state.displayPlayer && null == s.MediaPageStore.get("media-load-error-type") ? r.createElement("div", {
            ...
            (r.PureComponent);
            function S(e) {
                for (var t = null, n = [], r = location.search.substr(1).split("&"), i = 0; i < r.length; i++)
                    (n = r[i].split("="))[0] === e && (t = decodeURIComponent(n[1]));
                return t
            }
            w.defaultProps = {
                inEmbed: !0,
            ...
            new MutationObserver((function (e, t) {
                    ...
                    if (r)
                        return (n = videojs(r)).playsinline(!0), 1 == S("muted") && n.muted(!0), S("time") >= 0 && n.currentTime(S("time")), 1 == S("autoplay") && n.play(), void t.disconnect()
                })).observe(document, {
                childList: !0,
                subtree: !0
            })
        ...
        8727: function (e, t, n) {
            ...
            function c(e) {
                    ...
                    if (null === n && null === e.errorMessage && (e.inEmbed || (window.removeEventListener("focus", d), document.removeEventListener("visibilitychange", d)), t.current)) {
                        ...
                        if (void 0 !== e.subtitlesInfo && null !== e.subtitlesInfo && e.subtitlesInfo.length) {
                            ...
                            for (var f = 0; f < e.subtitlesInfo.length; )
                                void 0 !== e.subtitlesInfo[f].src && void 0 !== e.subtitlesInfo[f].srclang && void 0 !== e.subtitlesInfo[f].label && m.languages.push({
                        ...
                        n = new(u())(t.current, {
                            ...
                            volume: i.playerVolume,
                            soundMuted: i.playerSoundMuted,
                            theaterMode: i.inTheaterMode,
                            theSelectedQuality: void 0,
                            theSelectedPlaybackSpeed: i.videoPlaybackSpeed || 1
                        }, e.info, [.25, .5, .75, 1, 1.25, 1.5, 1.75, 2], s, a, o),
                        void 0 !== e.onPlayerInitCallback && e.onPlayerInitCallback(n, t.current)
                    }
                }
                return i.playerVolume = null === i.playerVolume ? 1 : Math.max(Math.min(Number(i.playerVolume), 1), 0),
                ...
                (0, r.useEffect)((function () {
                        return e.inEmbed || document.hasFocus() || "visible" === document.visibilityState ? d() : (window.addEventListener("focus", d), document.addEventListener("visibilitychange", d)),
                        ...
                        function () {
                            null !== n && (videojs(t.current).dispose(), n = null),
        ...
        5063: function (e, t, n) {
            ...
            p = function (e) {
                ...
                (0, i.useEffect)((function () {
                        f ? (0, l.addClassname)(document.body, "visible-sidebar") : (0, l.removeClassname)(document.body, "visible-sidebar"),
                        "media" !== o.PageStore.get("current-page") && 1023 < window.innerWidth && d.set("visible-sidebar", f)
                    }), [f]),
                (0, i.useEffect)((function () {
                    ...
                    toggleSidebar: function () {
                        ...
                        !function (e) {
                            ...
                            r = setTimeout((function () {
                                        "media" === o.PageStore.get("current-page") ? e ? (0, l.addClassname)(document.body, "overflow-hidden") : (0, l.removeClassname)(document.body, "overflow-hidden") : !e || 767 < window.innerWidth ? (0, l.removeClassname)(document.body, "overflow-hidden") : (0, l.addClassname)(document.body, "overflow-hidden"),
                                        e ? (0, l.addClassname)(document.body, "visible-sidebar") : (0, l.removeClassname)(document.body, "visible-sidebar"),
                                        r = setTimeout((function () {
                                                    r = null,
                                                    (0, l.removeClassname)(document.body, "sliding-sidebar")
                                                }), 220)
                                    }), 20)
                        }
                        (e),
        ...
        1394: function (e, t, n) {
            ...
            p = function (e) {
                ...
                v = function (e) {
                    var t = null,
                    n = null;
                    return void 0 !== e.darkMode && ((0, a.supportsSvgAsImg)() && void 0 !== e.darkMode.svg && "" !== e.darkMode.svg ? n = e.darkMode.svg : void 0 !== e.darkMode.img && "" !== e.darkMode.img && (n = e.darkMode.img)),
                ...
                b = y[1];
                (0, r.useEffect)((function () {
                        "dark" === f ? (0, a.addClassname)(document.body, "dark_theme") : (0, a.removeClassname)(document.body, "dark_theme"),
                        p.set("mode", f),
                        b(v[f])
                    }), [f]);
                var w = {
        ...
        1454: function (e, t, n) {
            ...
            function u() {
                ...
                window.addEventListener("scroll", (function () {
                    ...
                    win: function (t, n) {
                        "function" == typeof t && e.window.resize.push(t),
                        "function" == typeof n && e.window.scroll.push(n)
                    }
                }
            }
        },
        ...
        3899: function (e, t, n) {
            ...
            t.SidebarThemeSwitcher = function () {
                ...
                return r.enabled && "sidebar" === r.position && i.default.createElement("div", {
                    className: "sidebar-theme-switcher"
                }, i.default.createElement("div", {
                        className: "sidebar-theme-switcher-inner"
                    }, i.default.createElement("span", {
                            className: "theme-icon" + ("dark" === t ? "" : " active")
                        }, i.default.createElement("i", {
                                className: "material-icons",
                                "data-icon": "wb_sunny"
                            })), i.default.createElement("span", null, i.default.createElement("span", {
        ...
        645: function (e, t, n) {
            ...
            t.EmbedPage = function () {
                ...
                return l.useEffect((function () {
                        return u.MediaPageStore.on("loaded_video_data", o),
                        u.MediaPageStore.on("loaded_media_error", f),
                        d.MediaPageActions.loadMediaData(),
                        function () {
                            u.MediaPageStore.removeListener("loaded_video_data", o),
                            u.MediaPageStore.removeListener("loaded_media_error", f)
                        }
                    }), []),
                                ...
                                className: "error-container"
                                    ...
                                    className: "error-container-inner"
                                        ...
                                        className: "icon-wrap"
                                            ...
                                            className: "material-icons"
                                        }, "error_outline")), l.default.createElement("span", {
                                        className: "msg-wrap"
                                    }, u.MediaPageStore.get("media-load-error-message")))))), t && l.default.createElement(s.SiteConsumer, null, (function (e) {
                            return l.default.createElement(c.default, {
                                data: u.MediaPageStore.get("media-data"),
                                siteUrl: e.url,
                                containerStyles: m
                            })
                        })))
    ...
    function () {
        ...
        var t = function (t, n) {
            ...
            for (t && t(n); u < o.length; u++)
                a = o[u], r.o(e, a) && e[a] && e[a][0](), e[o[u]] = 0;
            return r.O(d)
        },
