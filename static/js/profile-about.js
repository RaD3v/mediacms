    ...
    t = {
        4254: function (e, t, n) {
            ...
            var j = function (e) {
                ...
                return k(n, [{
                            ...
                            key: "onSubmit",
                            value: function (e) {
                                this.state.isSending || "" === this.state.subject || "" === this.state.body || (e.preventDefault(), e.stopPropagation(), this.setState({
                                        isSending: !0
                                    }, (function () {
                ...
                return k(n, [{
                            ...
                            value: function () {
                                ...
                                if (this.state.author) {
                                    var r,
                                    i;
                                    if (null === this.userIsAuthor && (c.MemberContext._currentValue.is.anonymous ? (this.userIsAuthor = !1, this.enabledContactForm = !1) : (this.userIsAuthor = p.ProfilePageStore.get("author-data").username === c.MemberContext._currentValue.username, this.enabledContactForm = !this.userIsAuthor && c.MemberContext._currentValue.can.contactUser)), void 0 !== this.state.author.description && this.state.author.description && "" !== this.state.author.description && (e = this.state.author.description), void 0 !== this.state.author.location_info && this.state.author.location_info.length) {
                                        var a = [];
                                        for (r = 0; r < this.state.author.location_info.length; )
                                            void 0 !== this.state.author.location_info[r].title && void 0 !== this.state.author.location_info[r].url && a.push(o.createElement("a", {
                                                    key: r,
                                                    href: (0, s.formatInnerLink)(this.state.author.location_info[r].url, c.SiteContext._currentValue.url),
                                                    title: this.state.author.location_info[r].title
                                                }, this.state.author.location_info[r].title)), r += 1;
                                    ...
                                    if (void 0 !== this.state.author.home_page && this.state.author.home_page && "" !== this.state.author.home_page && "" !== (i = l()(this.state.author.home_page.trim()).toString()) && t.push(o.createElement("li", {
                                                key: "website"
                                            }, o.createElement("span", null, "Website:"), o.createElement("span", null, i))), void 0 !== this.state.author.social_media_links && this.state.author.social_media_links && "" !== this.state.author.social_media_links) {
        ...
        2915: function (e, t, n) {
            ...
            function l(e) {
                var t,
                n,
                o = (t = (0, r.useState)(e.active), n = 2, function (e) {
                    if (Array.isArray(e))
                        return e
                }
                    (t) || function (e, t) {
        ...
        2917: function (e, t, n) {
            ...
            function l(e) {
                ...
                n,
                i = (0, r.useRef)(null),
                a = (t = (0, r.useState)(null), n = 2, function (e) {
                    if (Array.isArray(e))
                        return e
                }
                    (t) || function (e, t) {
                ...
                (0, r.useEffect)((function () {
                        !function () {
                            for (var e = 0; e < s.length; )
                                s[e].elem.removeEventListener("click", s[e].listener), e += 1;
                            s = []
                        }
                        (),
                        l && (function () {
                            ...
                            if (a.length)
                                for (t = 0; t < a.length; )
                                    (n = (n = a[t].getAttribute(e.pageIdSelectorAttr)) ? n.trim() : n) && (s[t] = {
                                        ...
                                        (t), s[t].elem.addEventListener("click", s[t].listener)), t += 1;
        ...
        5671: function (e, t, n) {
            ...
            function l(e) {
                ...
                switch (-1 < o && (t[o] = r.createElement("span", {
                            key: "Text"
                        }, e.text)), -1 < i && (t[i] = r.createElement("span", {
                            key: "Icon",
        ...
        2436: function (e, t, n) {
            ...
            function f() {
                ...
                }, r.createElement("div", null, (e = o.default.get("notifications"), t = c.map((function (e) {
                                    ...
                                    return regeneratorRuntime.wrap((function (e) {
                                            for (; ; )
                                                ...
                                                case 0:
                                                    ...
                                                    return e.next = 6,
                                                    (0, r.get)(t, a).then(u).catch(l || null);
                                                case 6:
                                                    e.next = 9;
                                                    break;
                                                case 8:
                                    ...
                                    return regeneratorRuntime.wrap((function (e) {
                                            for (; ; )
                                                ...
                                                case 0:
                                                    ...
                                                    return e.next = 6,
                                                    (0, r.post)(t, n, o || null).then(l).catch(c || null);
                                                case 6:
                                                    e.next = 9;
                                                    break;
                                                case 8:
                                    ...
                                    return regeneratorRuntime.wrap((function (e) {
                                            for (; ; )
                                                ...
                                                case 0:
                                                    ...
                                                    return e.next = 6,
                                                    (0, r.put)(t, n, o || null).then(l).catch(c || null);
                                                case 6:
                                                    e.next = 9;
                                                    break;
                                                case 8:
    ...
    function () {
        ...
        var t = function (t, n) {
            ...
            for (t && t(n); c < a.length; c++)
                i = a[c], r.o(e, i) && e[i] && e[i][0](), e[a[c]] = 0;
            return r.O(s)
        },
