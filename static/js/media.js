    ...
    t = {
        3683: function (e, t, n) {
            ...
            var P = function (e) {
                ...
                (n = [{
                            ...
                            value: function () {
                                ...
                                document.hasFocus() || "visible" === document.visibilityState ? this.initPlayerInstance() : (this.initPlayerInstance = this.initPlayerInstance.bind(this), window.addEventListener("focus", this.initPlayerInstance), document.addEventListener("visibilitychange", this.initPlayerInstance))
                            }
                        }, {
                            key: "componentWillUnmount",
                            value: function () {
                                this.recommendedMedia && (this.AudioPlayerData.instance.player.off("fullscreenchange", this.recommendedMedia.onResize), o.PageStore.removeListener("window_resize", this.recommendedMedia.onResize), o.VideoViewerStore.removeListener("changed_viewer_mode", this.recommendedMedia.onResize), this.recommendedMedia.destroy()),
                            ...
                            value: function () {
                                ...
                                setTimeout(function () {
                                    if (!this.AudioPlayerData.instance) {
                                        ...
                                        e && (e.setAttribute("class", "title-link"), e.setAttribute("href", o.MediaPageStore.get("media-data").url), e.setAttribute("title", o.MediaPageStore.get("media-data").title), e.setAttribute("target", "_blank"), e.innerHTML = o.MediaPageStore.get("media-data").title),
                                        t && (t.setAttribute("class", "user-thumb-link"), t.setAttribute("href", o.MediaPageStore.get("media-data").author_profile), t.setAttribute("title", o.MediaPageStore.get("media-data").author_name), t.setAttribute("target", "_blank"), t.innerHTML = '<img src="' + o.MediaPageStore.get("media-author-thumbnail-url") + '" alt="" />');
                                        var n = null,
                                        r = null;
                                        !this.props.inEmbed && o.MediaPageStore.get("playlist-id") ? (n = o.MediaPageStore.get("playlist-next-media-url"), r = o.MediaPageStore.get("playlist-previous-media-url")) : n = o.MediaPageStore.get("media-data").related_media.length && !this.props.inEmbed ? o.MediaPageStore.get("media-data").related_media[0].url : null,
                                        ...
                                        this.AudioPlayerData.instance.player.one("play", function () {
                                            ...
                                            .bind(this)),
                                        this.recommendedMedia && (this.recommendedMedia.initWrappers(this.AudioPlayerData.instance.player.el_), this.AudioPlayerData.instance.player.one("pause", this.recommendedMedia.init), this.AudioPlayerData.instance.player.on("fullscreenchange", this.recommendedMedia.onResize), o.PageStore.on("window_resize", this.recommendedMedia.onResize), o.VideoViewerStore.on("changed_viewer_mode", this.recommendedMedia.onResize)),
            ...
            function _(e) {
                ...
                var r,
                l,
                s = (r = (0, a.useState)(n), l = 2, function (e) {
                    if (Array.isArray(e))
                        return e
                }
                    (r) || function (e, t) {
                ...
                function u(e) {
                    ...
                    if ("string" == typeof t.props.data.poster_url ? t.videoPoster = (0, m.formatInnerLink)(t.props.data.poster_url, t.props.siteUrl) : "string" == typeof t.props.data.thumbnail_url && (t.videoPoster = (0, m.formatInnerLink)(t.props.data.thumbnail_url, t.props.siteUrl)), t.videoInfo = (0, A.RA)(t.props.data.encodings_info, t.props.data.hls_info), Object.keys(t.videoInfo).length) {
                        ...
                        for (l in t.props.data.encodings_info[r])
                            t.props.data.encodings_info[r].hasOwnProperty(l) && c.support[l] && (a = t.props.data.encodings_info[r][l].url) && (a = (0, m.formatInnerLink)(a, t.props.siteUrl), t.videoSources.push({
                                    src: a,
            ...
            new MutationObserver((function (e, t) {
                    ...
                    if (r)
                        return (n = videojs(r)).playsinline(!0), 1 == L("muted") && n.muted(!0), L("time") >= 0 && n.currentTime(L("time")), 1 == L("autoplay") && n.play(), void t.disconnect()
                })).observe(document, {
                childList: !0,
                subtree: !0
            }),
            ...
            U = function (e) {
                ...
                n.default.plugin("markers", (function (e) {
                        ...
                        function v(e, t) {
                            ...
                            if ((n < 0 || n > 1) && (t.style.display = "none"), t.style.left = g(e) + "%", e.duration)
                                t.style.width = e.duration / d.duration() * 100 + "%", t.style.marginLeft = "0px";
                            else {
                                var r = i(t);
                        ...
                        function b(e) {
                            f && (p = o, f.style.visibility = "hidden"),
                            c = o;
                            var t = [];
                            e.forEach((function (e) {
                                    var n = u[e];
            ...
            function se(e) {
                ...
                r = [];
                if (e.length)
                    for (t = 0, n = 1 < e.length ? ", " : ""; t < e.length; )
            ...
            function he() {
                ...
                function u() {
                    ...
                    s((0, m.formatViewsNumber)(o.MediaPageStore.get("media-dislikes"), !1))
                }
                function c() {
                    u(),
            ...
            function be() {
                ...
                function u() {
                    ...
                    s((0, m.formatViewsNumber)(o.MediaPageStore.get("media-likes"), !1))
                }
                function c() {
                    u(),
            ...
            function We(e) {
                ...
                (0, a.useEffect)((function () {
                        ...
                        return S(i),
                        P((a = (t = parseInt(i, 10)) - 3600 * (n = Math.floor(t / 3600)) - 60 * (r = Math.floor((t - 3600 * n) / 60)), n < 10 && (n = "0" + n), r < 10 && (r = "0" + r), a < 10 && (a = "0" + a), n >= 1 ? n + ":" + r + ":" + a : r + ":" + a)),
                        function () {
                ...
                (n = [{
                            ...
                            value: function () {
                                ...
                                return this.state.videoLoaded && (s = void 0 === (s = o.MediaPageStore.get("media-data").allow_download) || !!s, e = o.MediaPageStore.get("media-data").views, t = o.MediaPageStore.get("media-data").categories_info, n = o.MediaPageStore.get("media-data").title, r = {
                                    ...
                                    }, i = o.MediaPageStore.get("media-data").add_date, l = o.MediaPageStore.get("media-data").description),
                ...
                function s(e) {
                    ...
                    if (function (e, t) {
                        if (!(e instanceof t))
                            ...
                            }, e.playlistData)for (var n = 0; n < e.playlistData.playlist_media.length; ) {
        ...
        8727: function (e, t, n) {
            ...
            function d(e) {
                ...
                (0, r.useEffect)((function () {
                        return e.inEmbed || document.hasFocus() || "visible" === document.visibilityState ? c() : (window.addEventListener("focus", c), document.addEventListener("visibilitychange", c)),
                    ...
                    if (void 0 !== e && e && void 0 !== e.data && e.data) {
                        ...
                        if ("string" == typeof j.poster_url ? o = (0, u.formatInnerLink)(j.poster_url, n.url) : "string" == typeof j.thumbnail_url && (o = (0, u.formatInnerLink)(j.thumbnail_url, n.url)), Object.keys(l).length) {
                            ...
                            for (r in j.encodings_info[y])
                                j.encodings_info[y].hasOwnProperty(r) && m.support[r] && (t = j.encodings_info[y][r].url) && (t = (0, u.formatInnerLink)(t, n.url), a.push({
                                        src: t,
    ...
    function () {
        ...
        var t = function (t, n) {
            ...
            for (t && t(n); u < o.length; u++)
                i = o[u], r.o(e, i) && e[i] && e[i][0](), e[o[u]] = 0;
            return r.O(c)
        },
