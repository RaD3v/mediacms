(function (global) {
    ...
    (function () {
        ...
        qq.dataUriToBlob = function (e) {
            ...
            r = t,
            a = o,
            (l = (s = window.BlobBuilder || window.WebKitBlobBuilder || window.MozBlobBuilder || window.MSBlobBuilder) && new s) ? (l.append(r), l.getBlob(a)) : new Blob([r], {
                type: a
            })
        },
        qq.log = function (e, t) {
    ...
    qq.supportedFeatures = function () {
        ...
        o = (n = i && ("draggable" in(f = document.createElement("span")) || "ondragstart" in f && "ondrop" in f) && !qq.android() && !qq.ios()) && (qq.chrome() || qq.opera()) && void 0 !== navigator.userAgent.match(/Chrome\/[2][1-9]|Chrome\/[3-9][0-9]/),
        r = i && qq.isFileChunkingSupported(),
        a = i && r && function () {
            try {
        ...
        (),
        s = i && (qq.chrome() || qq.opera()) && void 0 !== navigator.userAgent.match(/Chrome\/[1][4-9]|Chrome\/[2-9][0-9]/),
        l = e && (void 0 !== window.postMessage || i),
        c = m(),
        u = g(),
        d = !!m() || g(),
        p = void 0 !== document.createElement("input").webkitdirectory,
        h = i && void 0 !== window.FileReader,
        q = !!i && !qq.androidStock() && !qq.iosChrome(), {
            ajaxUploading: i,
            blobUploading: t,
            canDetermineSize: i,
            chunking: r,
    ...
    qq.UploadButton = function (e) {
        ...
        function a() {
            var e = document.createElement("input");
            return e.setAttribute(qq.UploadButton.BUTTON_ID_ATTR_NAME, n),
            e.setAttribute("title", r.title),
            i.setMultiple(r.multiple, e),
            r.folders && qq.supportedFeatures.folderSelection && e.setAttribute("webkitdirectory", ""),
            r.acceptFiles && e.setAttribute("accept", r.acceptFiles),
    ...
    qq.UploadData = function (e) {
        ...
        qq.extend(this, {
            addFile: function (a) {
                ...
                return a.batchId && (t[l].batchId = a.batchId, void 0 === r[a.batchId] && (r[a.batchId] = []), r[a.batchId].push(l)),
                a.proxyGroupId && (t[l].proxyGroupId = a.proxyGroupId, void 0 === o[a.proxyGroupId] && (o[a.proxyGroupId] = []), o[a.proxyGroupId].push(l)),
                t[l].id = l,
                n[a.uuid] = l,
                void 0 === i[s] && (i[s] = []),
                i[s].push(l),
    ...
    function () {
        ...
        qq.basePublicApi = {
            ...
            addFiles: function (e, t, n) {
                ...
                e && (qq.isFileList(e) && (e = Array.prototype.slice.call(e)), e = [].concat(e), qq.each(e, (function (e, t) {
        ...
        qq.basePrivateApi = {
            ...
            _itemError: function (e, t, n) {
                ...
                d("{file}", this._options.formatFileName(l)),
                d("{extensions}", i),
                d("{sizeLimit}", this._formatSize(c.sizeLimit)),
                d("{minSizeLimit}", this._formatSize(c.minSizeLimit)),
                null !== (o = r.match(/(\{\w+\})/g)) && qq.each(o, (function (e, t) {
                        d(t, s[e])
                    })),
                this._options.callbacks.onError(null, l, r, void 0),
                r
            },
            _manualRetry: function (e, t) {
                if (this._onBeforeManualRetry(e))
                    return this._netUploadedOrQueued++, this._uploadData.setStatus(e, qq.status.UPLOAD_RETRYING), t ? t(e) : this._handler.retry(e), !0
            },
            ...
            _onComplete: function (e, t, n, i) {
                return n.success ? (n.thumbnailUrl && (this._thumbnailUrls[e] = n.thumbnailUrl), this._netUploaded++, this._uploadData.setStatus(e, qq.status.UPLOAD_SUCCESSFUL)) : (this._netUploadedOrQueued--, this._uploadData.setStatus(e, qq.status.UPLOAD_FAILED), !0 === n[this._options.retry.preventRetryResponseProperty] && (this._preventRetries[e] = !0)),
            ...
            _preventLeaveInProgress: function () {
                ...
                this._disposeSupport.attach(window, "beforeunload", (function (t) {
                        if (e.getInProgress())
                            return (t = t || window.event).returnValue = e._options.messages.onLeave, e._options.messages.onLeave
                    }))
            },
    ...
    qq.AjaxRequester = function (e) {
        ...
        if (qq.extend(r, e), t = r.log, qq.indexOf(r.validMethods, r.method) < 0)
            throw new Error("'" + r.method + "' is not a supported method for this type of request!");
        function a(e) {
        ...
        function s(e, t) {
            ...
            return n || (n = t || (r.cors.expected ? function () {
                    var e;
                    return (window.XMLHttpRequest || window.ActiveXObject) && void 0 === (e = qq.createXhrInstance()).withCredentials && ((e = new XDomainRequest).onload = function () {}, e.onerror = function () {}, e.ontimeout = function () {}, e.onprogress = function () {}),
                    e
                }
                        () : qq.createXhrInstance()), o[e].xhr = n),
            n
        }
        function l(e) {
        ...
        function u(e, n) {
            ...
            c = !0 === n;
            l(e),
            c ? t(u + " request for " + e + " has failed", "error") : a(o) || (i = o.status, qq.indexOf(r.successfulResponseCodes[r.method], i) >= 0) || (c = !0, t(u + " request for " + e + " has failed - response code " + o.status, "error")),
            r.onComplete(e, o, c)
        }
        function c(e, i) {
            var l,
            ...
            p = function (e) {
                var t,
                n = o[e].additionalParams,
                i = r.mandatedParams;
                return r.paramsStore.get && (t = r.paramsStore.get(e)),
            ...
            (e, p, o[e].additionalQueryParams),
            a(c) ? (c.onload = function (e) {
                return function () {
                    u(e)
                }
            }
            ...
            (e),
            c.open(d, l, !0),
            r.cors.expected && r.cors.sendCredentials && !a(c) && (c.withCredentials = !0),
            function (e) {
                var t,
                n = s(e),
                i = r.customHeaders,
                l = o[e].additionalHeaders || {},
                u = r.method,
                c = {};
            ...
            (e),
            t("Sending " + d + " request for " + e),
            h ? c.send(h) : n || !p ? c.send() : p && r.contentType && r.contentType.toLowerCase().indexOf("application/x-www-form-urlencoded") >= 0 ? c.send(qq.obj2url(p, "")) : p && r.contentType && r.contentType.toLowerCase().indexOf("application/json") >= 0 ? c.send(JSON.stringify(p)) : c.send(p),
            c
        }
        n = "GET" === r.method || "DELETE" === r.method,
        qq.extend(this, {
    ...
    qq.UploadHandlerController = function (e, t) {
        ...
        c = {
                ...
                u.onUploadChunkSuccess(e, o._getChunkDataForCallback(r), n, i)
            },
            finalize: function (e) {
                var t = u.getSize(e),
                n = u.getName(e);
            ...
            handleFailure: function (e, t, n, r) {
                ...
                h.reset ? c.reset(t) : (s = qq.indexOf(o._getFileState(t).chunking.inProgress, e)) >= 0 && (o._getFileState(t).chunking.inProgress.splice(s, 1), o._getFileState(t).chunking.remaining.unshift(e)),
            ...
            sendNext: function (e) {
                ...
                null == r && 0 === h.length ? c.finalize(e) : (i(qq.format("Sending chunked upload request for item {}.{}, bytes {}-{} of {}.", e, r, a.start + 1, a.end, t)), u.onUploadChunk(e, n, o._getChunkDataForCallback(a)), h.push(r), o._getFileState(e).chunking.inProgress = h, l && d.open(e, r), l && d.available() && o._getFileState(e).chunking.remaining.length && c.sendNext(e), 0 === a.blob.size ? (i(qq.format("Chunk {} for file {} will not be uploaded, zero sized chunk.", r, e), "error"), c.handleFailure(r, e, "File is no longer available", null)) : o.uploadChunk(e, r, s).then((function (t, n) {
                            ...
                            c.hasMoreParts(e) || 0 !== a.length ? c.hasMoreParts(e) ? c.sendNext(e) : i(qq.format("File ID {} has no more chunks to send and these chunk indexes are still marked as in-progress: {}", e, JSON.stringify(a))) : c.finalize(e)
                        }), (function (t, n) {
        ...
        d = {
            ...
            free: function (e, t) {
                ...
                a >= 0 ? d._waiting.splice(a, 1) : r && s >= 0 && (d._open.splice(s, 1), (n = d._waiting.shift()) >= 0 && (d._open.push(n), p.start(n)))
            },
            ...
            open: function (e, t) {
                return null == t && d._waiting.push(e),
                !!d.available() && (null == t ? (d._waiting.pop(), d._open.push(e)) : ((n = d._openChunks[e] || []).push(t), d._openChunks[e] = n), !0);
                var n
            },
            reset: function () {
                d._waiting = [],
        ...
        p = {
            cancel: function (e) {
                i("Cancelling " + e),
                u.paramsStore.remove(e),
                d.free(e)
            },
            cleanup: function (e, t, n) {
                var i = u.getName(e);
                u.onComplete(e, i, t, n),
            ...
            maybeDefer: function (e, t) {
                return t && !o.getFile(e) && t instanceof qq.BlobProxy ? (u.onUploadPrep(e), i("Attempting to generate a blob on-demand for " + e), t.create().then((function (t) {
                            ...
                            u.onComplete(e, u.getName(e), qq.extend(o, n), null),
                            p.maybeSendDeferredFiles(e),
                            d.free(e)
            ...
            normalizeResponse: function (e, t) {
                var n = e;
                return qq.isObject(e) || (n = {}, qq.isString(e) && !t && (n.error = e)),
                n.success = t,
                n
            },
            now: function (e) {
                ...
                u.onUpload(e, t),
                s && o._shouldChunkThisFile(e) ? c.sendNext(e) : function (e, t) {
                    o._getFileState(e).loaded = 0,
        ...
        qq.extend(this, {
            ...
            retry: function (e) {
                return l && (o._getFileState(e).temp.ignoreFailure = !1),
                d.isUsingConnection(e) ? p.start(e) : a.upload(e)
            },
            cancel: function (e) {
                var t = o.cancel(e);
        ...
        qq.extend(u, e),
        i = u.log,
        s = u.chunking.enabled && qq.supportedFeatures.chunking,
        l = s && u.chunking.concurrent.enabled,
        (r = {})[u.preventRetryParam] = !0,
        n = r,
        p.initHandler()
    },
    ...
    qq.FormUploadHandler = function (e) {
        ...
        qq.override(this, (function (e) {
                return {
                    add: function (t, n) {
                        ...
                        n.setAttribute("name", u),
                        n.parentNode && qq(n).remove()
                    },
                    expunge: function (t) {
                        !function (e) {
                            delete a[e],
                            l && (clearTimeout(s[e]), delete s[e], p.stopReceivingMessages(e));
        ...
        qq.extend(this, {
            ...
            _attachLoadEvent: function (e, t) {
                ...
                l ? function (e, t) {
                    ...
                    p.receiveMessage(i, (function (e) {
                            d("Received the following window message: '" + e + "'"),
                            h(i);
                            var t,
                            o = n._parseJsonResponse(e),
                            a = o.uuid;
            ...
            _createIframe: function (e) {
                var t,
                i;
                return t = n._getIframeName(e),
                (i = qq.toElement("<iframe src='javascript:false;' name='" + t + "' />")).setAttribute("id", t),
    ...
    qq.XhrUploadHandler = function (e) {
        ...
        s = r && e.options.resume.enabled && a && qq.supportedFeatures.resume,
        l = i.getName,
        u = i.getSize,
        c = i.getUuid,
        d = i.getEndpoint,
        ...
        qq.override(this, (function (e) {
                return {
                    add: function (n, i) {
                        ...
                        t._initTempState(n),
                        s && t._maybePrepareForResume(n)
                    },
                    expunge: function (n) {
                        m(n),
                        t._maybeDeletePersistedChunkData(n),
                        t._clearXhrs(n),
                        e.expunge(n)
                    }
                }
        ...
        qq.extend(this, {
            ...
            clearXhr: function (e, n) {
                ...
                i.xhrs && delete i.xhrs[n],
                i.ajaxRequesters && delete i.ajaxRequesters[n]
            },
            ...
            moveInProgressToRemaining: function (e, n, i) {
                var o = n || t._getFileState(e).chunking.inProgress,
                r = i || t._getFileState(e).chunking.remaining;
                o && (f(qq.format("Moving these chunks from in-progress {}, to remaining.", JSON.stringify(o))), o.reverse(), qq.each(o, (function (e, t) {
                            r.unshift(t)
                        })), o.length = 0)
            },
            pause: function (e) {
                if (t.isValid(e))
                    return f(qq.format("Aborting XHR upload for {} '{}' due to pause instruction.", e, l(e))), t._getFileState(e).paused = !0, m(e), !0
            },
            reevaluateChunking: function (e) {
                if (o && t.isValid(e)) {
                    ...
                    if (delete r.chunking, r.chunking = {}, (n = t._getTotalChunks(e)) > 1 || o.mandatory) {
                        for (r.chunking.enabled = !0, r.chunking.parts = n, r.chunking.remaining = [], i = 0; i < n; i++)
                            r.chunking.remaining.push(i);
                        t._initTempState(e)
                    } else
                        r.chunking.enabled = !1
                }
            },
            ...
            _maybeDeletePersistedChunkData: function (e) {
                var n;
                return !!(s && t.isResumable(e) && (n = t._getLocalStorageId(e)) && localStorage.getItem(n)) && (localStorage.removeItem(n), !0)
            },
            _maybePrepareForResume: function (e) {
                var n,
                i,
                o = t._getFileState(e);
                s && void 0 === o.key && (n = t._getLocalStorageId(e), (i = localStorage.getItem(n)) && (i = JSON.parse(i), p(i.uuid) ? t._markNotResumable(e) : (f(qq.format("Identified file with ID {} and name of {} as resumable.", e, l(e))), h(e, i.uuid), o.key = i.key, o.chunking = i.chunking, o.loaded = i.loaded, o.attemptingResume = !0, t.moveInProgressToRemaining(e))))
            },
            _maybePersistChunkedState: function (e) {
                var n,
                i,
                o = t._getFileState(e);
                if (s && t.isResumable(e)) {
                    n = t._getLocalStorageId(e),
                    i = {
                        name: l(e),
                        size: u(e),
                        uuid: c(e),
            ...
            _removeExpiredChunkingRecords: function () {
                ...
                t._iterateResumeRecords((function (t, n) {
                        ...
                        i.getTime() <= Date.now() && (f("Removing expired resume record with key " + t), localStorage.removeItem(t))
                    }))
            },
            _shouldChunkThisFile: function (e) {
                var n = t._getFileState(e);
                return n.chunking || t.reevaluateChunking(e),
                n.chunking.enabled
            }
        })
    },
    qq.DeleteFileAjaxRequester = function (e) {
        ...
        qq.extend(this, {
            sendDelete: function (e, i, o) {
                ...
                "DELETE" === n.method ? t.initTransport(e).withPath(i).withParams(r).send() : (r[n.uuidParamName] = i, t.initTransport(e).withParams(r).send())
            }
        })
    },
    function () {
        function e(e, n, i, o, r) {
            ...
            ({
                ...
                p = r ? function (e, t, n) {
                    ...
                    l = n,
                    u = n;
                    for (a.width = 1, a.height = n, (i = a.getContext("2d")).drawImage(e, 0, 0), o = i.getImageData(0, 0, 1, n).data; u > s; )
                        0 === o[4 * (u - 1) + 3] ? l = u : s = u, u = l + s >> 1;
                    return 0 == (r = u / n) ? 1 : r
                }
                (e, 0, l) : 1,
                h = Math.ceil(o * u / s),
                ...
                for (a.width = a.height = o, t = a.getContext("2d"); f < l; ) {
                    for (n = 0, i = 0; n < s; )
                        t.clearRect(0, 0, o, o), t.drawImage(e, -n, -f), d.drawImage(a, 0, 0, o, o, i, m, h, q), n += o, i += h;
                    f += o,
                    m += q
                }
                d.restore(),
        ...
        qq.extend(this, {
            generate: function (i, l, u) {
                return qq.isString(i) ? (e("Attempting to update thumbnail based on server response."), function (e, i, l) {
                    ...
                    d = l.scale,
                    p = d ? l.maxSize : null;
                    return d && t(i) ? (u = document.createElement("canvas")).getContext && u.getContext("2d") ? o(e) && void 0 === (new Image).crossOrigin ? s(e, i, c, p) : a(e, i, c, p) : s(e, i, c, p) : n(i) ? a(e, i, c, p) : r(i, c) && (i.src = e),
                    c
                }
                    (i, l, u || {})) : (e("Attempting to draw client-side image preview."), function (t, n, i) {
                    var o = new qq.Promise,
    ...
    qq.Exif = function (e, t) {
        ...
        function r(t, n) {
            var i = t,
            o = n;
            return void 0 === i && (i = 2, o = new qq.Promise),
            qq.readBlobToHex(e, i, 4).then((function (e) {
                    var t,
                    n = /^ffe([0-9])/.exec(e);
        ...
        qq.extend(this, {
            parse: function () {
                ...
                return a().then((function (a) {
                        ...
                        (l = a, u = new qq.Promise, qq.readBlobToHex(e, l + 10, 2).then((function (e) {
                                    u.success("4949" === e)
                                })), u).then((function (l) {
                                ...
                                function (t, n) {
                                    ...
                                    return qq.readBlobToHex(e, t + 18, 2).then((function (e) {
                                            if (n)
                                                return i.success(o(e));
                                            i.success(parseInt(e, 16))
                                        })),
                                    i
                                }
                                (a, l).then((function (u) {
                                        t(qq.format("Found {} APP1 directory entries", u)),
                                        function (t, n) {
                                            var i = t + 20,
                                            o = 12 * n;
                                        ...
                                        (a, u).then((function (e) {
                                                ...
                                                s = function (e, t) {
                                                    ...
                                                    return qq.each(t, (function (t, n) {
                                                            ...
                                                            p = r.indexOf(d);
                                                            if (p >= 0 && (l = i[d].name, u = i[d].bytes, s = n.slice(16, 16 + 2 * u), a[l] = e ? o(s) : parseInt(s, 16), r.splice(p, 1)), 0 === r.length)
                                                                return !1
                                                        })),
                                                    a
                                                }
                ...
                this.isPreviewableSync() ? (t("Second pass: check for magic bytes in file header."), qq.readBlobToHex(e, 0, 4).then((function (e) {
                            qq.each(n.PREVIEWABLE_MIME_TYPES, (function (t, n) {
                                    if (r = e, a = !1, s = [].concat(n), qq.each(s, (function (e, t) {
                                        ...
                                        return ("image/tiff" !== t || qq.supportedFeatures.tiffPreviews) && (o = !0, i.success(t)), !1;
                                    var r,
                                    a,
                                    s
                                })),
    ...
    qq.Session = function (e) {
        ...
        this.refresh = function () {
            ...
            n = qq.extend({}, t);
            return new qq.SessionAjaxRequester(qq.extend(n, {
                        ...
                        !function (e, n, i, o) {
                            ...
                            (n = n && function (e) {
                                ...
                                (e)) && qq.each(e, (function (e, n) {
                                    if (null == n.uuid)
                                        r = !0, t.log(qq.format("Session response item {} did not include a valid UUID - ignoring.", e), "error");
                                    else if (null == n.name)
                                        r = !0, t.log(qq.format("Session response item {} did not include a valid name - ignoring.", e), "error");
                                    else
                                        try {
                                            return t.addFileRecord(n),
                                            !0
                                        } catch (e) {
                                            r = !0,
                                            t.log(e.message, "error")
                                        }
                                    return !1
                                })),
    ...
    qq.TotalProgress = function (e, t) {
        ...
        u = function (e, t, r) {
            ...
            l = n[e] ? n[e].total : 0;
            -1 === t && -1 === r ? (i -= a, o -= l) : (t && (i += t - a), r && (o += r - l)),
            s(i, o)
        };
        qq.extend(this, {
    ...
    qq.FormSupport = function (e, t, n) {
        ...
        a = e.autoUpload;
        function s(e, t) {
            if (!e.checkValidity || e.checkValidity())
                return !0;
    ...
    qq.extend(qq.FormSupport.prototype, {
        _form2Obj: function (e) {
            ...
            n = function (e) {
                return t = e.type,
                qq.indexOf(["checkbox", "radio"], t.toLowerCase()) >= 0 && !e.checked || e.disabled && "hidden" !== e.type.toLowerCase();
                var t
            };
            return qq.each(e.elements, (function (e, i) {
                    if ((qq.isInput(i, !0) || "textarea" === i.tagName.toLowerCase()) && (r = i.type, qq.indexOf(["button", "image", "reset", "submit"], r.toLowerCase()) < 0) && !n(i))
                        t[i.name] = i.value;
    ...
    qq.traditional.FormUploadHandler = function (e, t) {
        ...
        this.uploadFile = function (t) {
            ...
            return (a = function (t, r) {
                ...
                u = i(t);
                return a[e.uuidName] = o(t),
                a[e.filenameParam] = u,
                n._initFormForUpload({
                    method: s,
                    endpoint: l,
                    params: a,
                ...
                (t, l)).appendChild(s),
            n._attachLoadEvent(l, (function (i) {
                    r("iframe loaded");
                    var o = i || function (e, t) {
                        ...
                        a;
                        try {
                            a = (o = t.contentDocument || t.contentWindow.document).body.innerHTML,
                            r("converting iframe's innerHTML to JSON"),
                            r("innerHTML = " + a),
                            a && a.match(/^<pre/i) && (a = o.body.firstChild.firstChild.nodeValue),
                    ...
                    (0, l);
                    n._detachLoadEvent(t),
                    e.cors.expected || qq(l).remove(),
                    o.success ? u.success(o) : u.failure(o)
                })),
            r("Sending upload request for " + t),
            a.submit(),
            qq(a).remove(),
            u
        },
    ...
    qq.traditional.XhrUploadHandler = function (e, t) {
        ...
        qq.extend(this, {
            uploadChunk: function (t, r, a) {
                ...
                c,
                d,
                p = n._getChunkData(t, r),
                f = n._createXhr(t, r);
                return o(t),
                l = u(t, f),
                n._registerProgressHandler(t, r, p.size),
                function (t, n, r) {
                    var a = o(t),
                    l = i(t);
                ...
                (t, d = e.paramsStore.get(t), p),
                a && (d[e.resume.paramNames.resuming] = !0),
                c = h(d, f, p.blob, t),
                q(t, f),
                f.send(c),
                l
    ...
    qq.DragAndDrop = function (e) {
                ...
                onDrop: function (e) {
                    ...
                    (i = e.dataTransfer, o = n, r = [], a = new qq.Promise, t.callbacks.processingDroppedFiles(), o.dropDisabled(!0), i.files.length > 1 && !t.allowMultipleItems ? (t.callbacks.processingDroppedFilesComplete([]), t.callbacks.dropError("tooManyFilesError", ""), o.dropDisabled(!1), a.failure()) : (s = [], qq.isFolderDropSupported(i) ? qq.each(i.items, (function (e, t) {
                                    ...
                                    n && (n.isFile ? s.push(t.getAsFile()) : r.push(u(n).done((function () {
                                                    r.pop(),
                                                    0 === r.length && a.success()
                                                }))))
                                })) : s = i.files, 0 === r.length && a.success()), a).then((function () {
                            !function (e, n) {
                                var i = Array.prototype.slice.call(e);
                                t.callbacks.dropLog("Grabbed " + e.length + " dropped files."),
                                n.dropDisabled(!1),
        ...
        qq.extend(t, e, !0),
        n = t.dropZoneElements,
        i = function () {
            setTimeout((function () {
                    qq.each(n, (function (e, n) {
                            qq(n).hasAttribute(r) && qq(n).hide(),
                            qq(n).removeClass(t.classes.dropActive)
                        }))
                }), 10)
        },
        qq.each(n, (function (e, t) {
        ...
        l.attach(document, o, i),
        qq.extend(this, {
            setupExtraDropzone: function (e) {
                t.dropZoneElements.push(e),
                d(e)
            },
            removeDropzone: function (e) {
                var n,
                i = t.dropZoneElements;
                for (n in i)
                    if (i[n] === e)
                        return i.splice(n, 1)
            },
    ...
    qq.UploadDropZone = function (e) {
        ...
        r.attach(n, "dragover", (function (e) {
                if (a(e)) {
    ...
    function () {
        ...
        qq.uiPrivateApi = {
            ...
            _onBeforeAutoRetry: function (e) {
                ...
                this._options.retry.showAutoRetryNote && (t = this._autoRetries[e], n = this._options.retry.maxAutoAttempts, i = (i = this._options.retry.autoRetryNote.replace(/\{retryNum\}/g, t)).replace(/\{maxAuto\}/g, n), this._templating.setStatusText(e, i), qq(this._templating.getFileContainer(e)).addClass(this._classes.retrying))
            },
            _onBeforeManualRetry: function (e) {
            ...
            _formatProgress: function (e, t) {
                ...
                return i("{percent}", Math.round(e / t * 100)),
                i("{total_size}", this._formatSize(t)),
                n
            },
    ...
    qq.Templating = function (e) {
        ...
        V = function (e) {
            ...
            qq.supportedFeatures.imagePreviews ? r ? v.limits.maxThumbs && v.limits.maxThumbs <= m ? (G(n, r), C()) : x(r).done((function () {
                    ...
                    null != o ? Y(n, o) : function (e, n, i) {
                        ...
                        n.qqThumbnailId = e,
                        v.imageGenerator.generate(n, o, i).then((function () {
                                m++,
                                Q(o),
                                S[e].success()
                            }), (function () {
                                S[e].failure(),
                                v.placeholders.waitUntilUpdate || G(e, o)
                            }))
                    }
                    (n, i, a)
                })) : C() : r && (x(r), C())
        ...
        X = function (e) {
            ...
            if (o)
                if (n) {
                    if (!(v.limits.maxThumbs && v.limits.maxThumbs <= m))
                        return i && x(o), v.imageGenerator.generate(n, o, r).then((function () {
                                Q(o),
                                m++,
                                setTimeout(C, v.limits.timeBetweenThumbs)
                            }), (function () {
        ...
        Y = function (e, n) {
            ...
            S[n].then((function () {
                    ...
                    S[e].failure(),
                    v.placeholders.waitUntilUpdate || G(e, i)
                }))
        };
        qq.extend(v, e),
        t = v.log,
        ...
        o = function () {
            ...
            f,
            m;
            if (t("Parsing template"), null == v.templateIdOrEl)
            ...
            if (o = qq.trimStr(o), (a = document.createElement("div")).appendChild(qq.toElement(o)), m = qq(a).getFirstByClass(y.uploader), v.button && (c = qq(a).getFirstByClass(y.button)) && qq(c).remove(), qq.DragAndDrop && qq.supportedFeatures.fileDrop || (q = qq(a).getFirstByClass(y.dropProcessing)) && qq(q).remove(), (p = qq(a).getFirstByClass(y.drop)) && !qq.DragAndDrop && (t("DnD module unavailable.", "info"), qq(p).remove()), qq.supportedFeatures.fileDrop ? qq(m).hasAttribute(d) && p && (f = qq(p).getFirstByClass(y.dropText)) && qq(f).remove() : (m.removeAttribute(d), p && qq(p).hasAttribute("qq-hide-dropzone") && qq(p).css({
                        display: "none"
                    })), h = qq(a).getFirstByClass(y.thumbnail), s ? h && (b = (b = parseInt(h.getAttribute("qq-max-size"))) > 0 ? b : null, l = qq(h).hasAttribute("qq-server-scale")) : h && qq(h).remove(), s = s && h, n = qq(a).getByClass(y.editFilenameInput).length > 0, i = qq(a).getByClass(y.retry).length > 0, null == (r = qq(a).getFirstByClass(y.list)))
        ...
        (),
        function () {
            var e = v.placeholders.thumbnailNotAvailable,
            n = v.placeholders.waitingForThumbnail,
            i = {
                maxSize: b,
                scale: l
            };
        ...
        qq.extend(this, {
            render: function () {
                ...
                a = v.fileContainerEl || H(r, y.list),
            ...
            addFile: function (e, t, n, i, s) {
                ...
                qq(p).addClass(c + e),
                g.removeAttribute(d),
                m && (qq(m).setText(t), m.setAttribute("title", t)),
                p.setAttribute(u, e),
                n ? function (e, t, n) {
                    var i = n,
                    o = i.firstChild;
                ...
                i ? (p.style.display = "none", qq(p).addClass(h)) : (M(B(e)), M(L(e)), M(D(e)), M(N(e)), M(R(e)), M(I(e)), f && this.hideCancel(e), (l = z(e)) && !l.src && F.then((function (e) {
                            l.src = e.src,
            ...
            markFilenameEditable: function (e) {
                var t = A(e);
                t && qq(t).addClass(v.classes.editable)
            },
            ...
            hideEditIcon: function (e) {
                var t = U(e);
                t && qq(t).removeClass(v.classes.editable)
            },
            ...
            updateProgress: function (e, t, n) {
                var i,
                o = B(e);
                o && n > 0 && (100 === (i = Math.round(t / n * 100)) ? M(o) : Q(o), W(e, i))
            },
            ...
            showCancel: function (e) {
                if (!f) {
                    var t = E(e);
                    t && qq(t).removeClass(v.classes.hide)
                }
            },
            ...
            uploadPaused: function (e) {
                this.setStatusText(e, v.text.paused),
            ...
            showDialog: function (e, t, n) {
                var i = P(e),
                o = H(i, y.dialogMessage),
                r = i.getElementsByTagName("INPUT")[0],
                a = H(i, y.dialogCancelButton),
                s = H(i, y.dialogOkButton),
                l = new qq.Promise,
                u = function () {
        ...
        t.onHandled = function (e, i) {
            qq.each(n, (function (n, o) {
                    ...
                    if (t.templating["is" + a](e))
                        return r = t.templating.getFileId(e), qq.preventDefault(i), t.log(qq.format("Detected valid file button click event on file '{}', ID: {}.", t.onGetName(r), r)), o(r), !1
                }))
        },
    ...
    qq.FilenameEditHandler = function (e, t) {
        ...
        function i(e, t) {
            ...
            void 0 !== o && qq.trimStr(o).length > 0 && (void 0 !== (i = function (e) {
                    ...
                    (t)) && (o = o + "." + i), n.onSetName(t, o)),
            n.onEditingStatusChange(t, !1)
        }
        qq.extend(n, e),
        n.attachTo = n.templating.getFileList(),
        qq.extend(this, new qq.UiEventHandler(n, t)),
        qq.extend(t, {
            handleFilenameEdit: function (e, o, r) {
                var a,
                s,
                l,
                u = n.templating.getEditInput(e);
                n.onEditingStatusChange(e, !0),
                u.value = (a = e, (l = (s = n.onGetName(a)).lastIndexOf(".")) > 0 && (s = s.substr(0, l)), s),
                r && u.focus(),
                function (e, n) {
