!function (global) {
    ...
    !function () {
        ...
        qq.toElement = (e = document.createElement("div"), function (t) {
            e.innerHTML = t;
            var n = e.firstChild;
        ...
        qq.obj2url = function (e, t, n) {
            ...
            return !n && t ? (o = /\?/.test(t) ? /\?$/.test(t) ? "" : "&" : "?", i.push(t), i.push(qq.obj2url(e))) : "[object Array]" === Object.prototype.toString.call(e) && void 0 !== e || null != e && "object" == typeof e ? qq.each(e, (function (e, t) {
                    r(t, e)
    ...
    qq.AjaxRequester = function (e) {
        ...
        function n(e, t) {
            ...
            return n || (n = t || (h.cors.expected ? function () {
                    ...
                    e
                        ...
                        () : qq.createXhrInstance()), p[e].xhr = n),
            n
        }
        function i(e) {
        ...
        function o(e, o) {
            ...
            (r.status) || (s = !0, u(a + " request for " + e + " has failed - response code " + r.status, "error")),
            h.onComplete(e, r, s)
        }
        function r(e, i) {
            var o,
            ...
            t(r) ? (r.onload = s(e), r.onerror = l(e)) : r.onreadystatechange = a(e),
            function (e) {
                var t = h.onProgress;
            ...
            function (e) {
                ...
                a = h.method,
                s = {};
                t(i) || (h.acceptHeader && i.setRequestHeader("Accept", h.acceptHeader), h.allowXRequestedWithAndCacheControl && (h.cors.expected && qq.indexOf(["GET", "POST", "HEAD"], h.method) >= 0 && !function (e) {
                        var t = !1;
                        ...
                        () || (i.setRequestHeader("X-Requested-With", "XMLHttpRequest"), i.setRequestHeader("Cache-Control", "no-cache"))), !h.contentType || "POST" !== a && "PUT" !== a || i.setRequestHeader("Content-Type", h.contentType), qq.extend(s, qq.isFunction(o) ? o(e) : o), qq.extend(s, r), qq.each(s, (function (e, t) {
        ...
        if (qq.extend(h, e), u = h.log, qq.indexOf(h.validMethods, h.method) < 0)
    ...
    qq.UploadHandlerController = function (e, t) {
        ...
        u = {
            ...
            handleFailure: function (e, t, n, r) {
                ...
                var p,
                h = d.normalizeResponse(n, !1);
                h.reset ? u.reset(t) : (p = qq.indexOf(o._getFileState(t).chunking.inProgress, e)) >= 0 && (o._getFileState(t).chunking.inProgress.splice(p, 1), o._getFileState(t).chunking.remaining.unshift(e)),
                o._getFileState(t).temp.ignoreFailure || (s && (o._getFileState(t).temp.ignoreFailure = !0, i(qq.format("Going to attempt to abort these chunks: {}. These are currently in-progress: {}.", JSON.stringify(Object.keys(o._getXhrs(t))), JSON.stringify(o._getFileState(t).chunking.inProgress))), qq.each(o._getXhrs(t), (function (e, n) {
                                ...
                                n.abort(),
                                n._cancelled = !0
                            })), o.moveInProgressToRemaining(t), c.free(t, !0)), l.onAutoRetry(t, a, h, r) || d.cleanup(t, h, r))
            },
        ...
        c = {
            ...
            free: function (e, t) {
                ...
                d.getProxyOrBlob(e)instanceof qq.BlobProxy && (i("Generated blob upload has ended for " + e + ", disposing generated blob."), delete o._getFileState(e).file),
                a >= 0 ? c._waiting.splice(a, 1) : r && s >= 0 && (c._open.splice(s, 1), (n = c._waiting.shift()) >= 0 && (c._open.push(n), d.start(n)))
            },
        ...
        d = {
            ...
            start: function (e) {
                ...
                return t ? d.maybeDefer(e, t) : (d.now(e), !0)
            }
        };
        qq.extend(this, {
            add: function (e, t) {
    ...
    qq.FormUploadHandler = function (e) {
        ...
        function n(e, n) {
            ...
            l[r] = qq(e).attach("load", (function () {
                        o.getInput(r) && (h("Received iframe load event for CORS upload request (iframe name " + i + ")"), u[i] = setTimeout((function () {
            ...
            q.receiveMessage(i, (function (e) {
                    ...
                    var n,
                    r = (t(i), o._parseJsonResponse(e)),
                    a = r.uuid;
                    a && s[a] ? (h("Handling response for iframe name " + i), clearTimeout(u[i]), delete u[i], o._detachLoadEvent(i), n = s[a], delete s[a], q.stopReceivingMessages(i), n(r)) : a || h("'" + e + "' does not contain a UUID - ignoring.")
                }))
        }
        var i = e.options,
        o = this,
        ...
        qq.override(this, (function (e) {
                return {
                    ...
                    expunge: function (t) {
                        (function (e) {
                            delete l[e],
                            c && (clearTimeout(u[e]), delete u[e], q.stopReceivingMessages(e));
    ...
    qq.XhrUploadHandler = function (e) {
        ...
        qq.extend(this, {
            ...
            pause: function (e) {
                if (n.isValid(e))
                    return m(qq.format("Aborting XHR upload for {} '{}' due to pause instruction.", e, u(e))), n._getFileState(e).paused = !0, t(e), !0
            },
            reevaluateChunking: function (e) {
                if (r && n.isValid(e)) {
                    ...
                    i,
                    o = n._getFileState(e);
                    if (delete o.chunking, o.chunking = {}, (t = n._getTotalChunks(e)) > 1 || r.mandatory) {
                        for (o.chunking.enabled = !0, o.chunking.parts = t, o.chunking.remaining = [], i = 0; i < t; i++)
            ...
            _maybePrepareForResume: function (e) {
                ...
                i,
                o = n._getFileState(e);
                l && void 0 === o.key && (t = n._getLocalStorageId(e), (i = localStorage.getItem(t)) && (i = JSON.parse(i), h(i.uuid) ? n._markNotResumable(e) : (m(qq.format("Identified file with ID {} and name of {} as resumable.", e, u(e))), q(e, i.uuid), o.key = i.key, o.chunking = i.chunking, o.loaded = i.loaded, o.attemptingResume = !0, n.moveInProgressToRemaining(e))))
            },
    ...
    function () {
        ...
        n.prototype.render = function (t, n) {
            ...
            return this.imageLoadListeners ? void this.imageLoadListeners.push((function () {
                    o.render(t, n)
                })) : (s && !l ? l = a * s / r << 0 : l && !s ? s = r * l / a << 0 : (s = r, l = a), u && s > u && (l = a * (s = u) / r << 0), c && l > c && (s = r * (l = c) / a << 0), i = {
                    width: s,
                    height: l
                }, qq.each(n, (function (e, t) {
                        i[e] = t
                ...
                () : "canvas" === p && e(this.srcImage, this.blob, t, i, d), void("function" == typeof this.onrender && this.onrender(t)))
        },
        qq.MegaPixImage = n
    }
    (),
    ...
    qq.Exif = function (e, t) {
        ...
        function s(e, t) {
            ...
            return qq.each(t, (function (t, r) {
                    ...
                    l,
                    c = r.slice(0, 4),
                    d = e ? n(c) : parseInt(c, 16),
                    p = i.indexOf(d);
                    if (p >= 0 && (s = u[d].name, l = u[d].bytes, a = r.slice(16, 16 + 2 * l), o[s] = e ? n(a) : parseInt(a, 16), i.splice(p, 1)), 0 === i.length)
                        return !1
                })),
            o
        }
    ...
    qq.Session = function (e) {
        ...
        function t(e, t, i, o) {
            ...
            (t = t && function (e) {
                ...
                (e)) && qq.each(e, (function (e, t) {
                    if (null == t.uuid)
                        r = !0, n.log(qq.format("Session response item {} did not include a valid UUID - ignoring.", e), "error");
                    else if (null == t.name)
                        r = !0, n.log(qq.format("Session response item {} did not include a valid name - ignoring.", e), "error");
                    else
                        try {
    ...
    qq.DragAndDrop = function (e) {
        ...
        function i(e, n) {
            ...
            n.dropDisabled(!0),
            e.files.length > 1 && !r.allowMultipleItems ? (r.callbacks.processingDroppedFilesComplete([]), r.callbacks.dropError("tooManyFilesError", ""), n.dropDisabled(!1), o.failure()) : (u = [], qq.isFolderDropSupported(e) ? qq.each(e.items, (function (e, n) {
                        var r = n.webkitGetAsEntry();
                        r && (r.isFile ? u.push(n.getAsFile()) : i.push(t(r).done((function () {
                                        i.pop(),
                                        0 === i.length && o.success()
                                    }))))
                    })) : u = e.files, 0 === i.length && o.success()),
            o
        }
        function o(e) {
    ...
    qq.Templating = function (e) {
        ...
        X = function (e) {
            ...
            qq.supportedFeatures.imagePreviews ? o ? b.limits.maxThumbs && b.limits.maxThumbs <= m ? (V(t, o), E()) : x(o).done((function () {
                    S[t] = new qq.Promise,
                    S[t].done((function () {
            ...
            if (o)
                if (n) {
                    if (!(b.limits.maxThumbs && b.limits.maxThumbs <= m))
                        return i && x(o), b.imageGenerator.generate(n, o, r).then((function () {
                                Y(o),
                                m++,
                                setTimeout(E, b.limits.timeBetweenThumbs)
                            }), (function () {
        ...
        qq.extend(b, e),
        t = b.log,
        qq.supportedFeatures.imagePreviews || (b.limits.timeBetweenThumbs = 0, b.limits.maxThumbs = 0),
        r = b.containerEl,
        ...
        o = function () {
            ...
            f,
            m;
            if (t("Parsing template"), null == b.templateIdOrEl)
            ...
            if (o = qq.trimStr(o), (a = document.createElement("div")).appendChild(qq.toElement(o)), m = qq(a).getFirstByClass(y.uploader), b.button && (c = qq(a).getFirstByClass(y.button)) && qq(c).remove(), qq.DragAndDrop && qq.supportedFeatures.fileDrop || (q = qq(a).getFirstByClass(y.dropProcessing)) && qq(q).remove(), (p = qq(a).getFirstByClass(y.drop)) && !qq.DragAndDrop && (t("DnD module unavailable.", "info"), qq(p).remove()), qq.supportedFeatures.fileDrop ? qq(m).hasAttribute(d) && p && (f = qq(p).getFirstByClass(y.dropText)) && qq(f).remove() : (m.removeAttribute(d), p && qq(p).hasAttribute("qq-hide-dropzone") && qq(p).css({
                        display: "none"
                    })), h = qq(a).getFirstByClass(y.thumbnail), s ? h && (v = (v = parseInt(h.getAttribute("qq-max-size"))) > 0 ? v : null, l = qq(h).hasAttribute("qq-server-scale")) : h && qq(h).remove(), s = s && h, n = qq(a).getByClass(y.editFilenameInput).length > 0, i = qq(a).getByClass(y.retry).length > 0, null == (r = qq(a).getFirstByClass(y.list)))
        ...
        function () {
            ...
            s && (e ? b.imageGenerator.generate(e, new Image, i).then((function (e) {
                    ...
                    })) : w.failure(), n ? b.imageGenerator.generate(n, new Image, i).then((function (e) {
                        F.success(e)
                    }), (function () {
                        F.failure(),
        ...
        qq.extend(this, {
            ...
            addFile: function (e, t, n, i, s) {
                ...
                i ? (p.style.display = "none", qq(p).addClass(h)) : (j(N(e)), j(O(e)), j(T(e)), j(L(e)), j(B(e)), j(P(e)), f && this.hideCancel(e), (l = M(e)) && !l.src && F.then((function (e) {
                            l.src = e.src,
            ...
            updateProgress: function (e, t, n) {
                var i,
                o = N(e);
                o && n > 0 && (100 === (i = Math.round(t / n * 100)) ? j(o) : Y(o), Q(e, i))
            },
